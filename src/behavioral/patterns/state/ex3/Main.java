...
import behavioral.patterns.state.ex3.profiles.MeetingProfile;
import behavioral.patterns.state.ex3.profiles.OutdoorProfile;
import behavioral.patterns.state.ex3.profiles.SleepingProfile;
import behavioral.patterns.state.ex3.states.Ring;
import behavioral.patterns.state.ex3.states.Silent;
import behavioral.patterns.state.ex3.states.Vibrate;
